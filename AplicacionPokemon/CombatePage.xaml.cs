...
namespace AplicacionPokemon
{
    ...
    public sealed partial class CombatePage : Page
    {
        ...
        private void btn_jug1_Click(object sender, RoutedEventArgs e)
        {
        ...
        private void btn_jug2_Click(object sender, RoutedEventArgs e)
        {
        ...
        private async void btn_atacar2_Click(object sender, RoutedEventArgs e)
        {
            if (fv_jugador2.SelectedIndex == 0 & fv_jugador1.SelectedIndex == 0)
            {
                ...
                jug2_espera.Text = "El jugador 2 ha decidido atacar.";
                jug2_espera.Visibility = Visibility.Visible;
                await Task.Delay(2000);
                if (fv_beedrill_seleccionado1.Vida <= 0)
                {
                    fondo_combate.Visibility = Visibility.Visible;
                    mensaje_victoria.Text = "El jugador 2 ha ganado el combate.";
                    mensaje_victoria.Visibility = Visibility.Visible;
                }
                else
                {
        ...
        private async void btn_curar2_Click(object sender, RoutedEventArgs e)
        {
            if (fv_jugador2.SelectedIndex == 0)
            {
                ...
                controles_jug2.Visibility = Visibility.Collapsed;
                jug2_espera.Text = "El jugador 2 ha decidido curarse.";
                jug2_espera.Visibility = Visibility.Visible;
                await Task.Delay(2000);
                bloqueo_jug2();
        ...
        private async void btn_subirEnergia2_Click(object sender, RoutedEventArgs e)
        {
            if (fv_jugador2.SelectedIndex == 0)
            {
                ...
                controles_jug2.Visibility = Visibility.Collapsed;
                jug2_espera.Text = "El jugador 2 ha decidido subir la energía.";
                jug2_espera.Visibility = Visibility.Visible;
                await Task.Delay(2000);
                bloqueo_jug2();
            }
